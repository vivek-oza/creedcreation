...
//       <div className="relative w-full max-w-6xl mx-auto px-4">
//         {/* Enhanced Horizontal Line (Desktop) */}
//         <div className="hidden md:block absolute top-1/2 left-0 right-0 h-[6px] mx-10 overflow-hidden z-0">
//           <motion.div
...
//             style={{
//               background:
//                 "linear-gradient(90deg,rgba(255,0,140,0) 0%, rgba(255,0,140,1) 15%, rgba(0,112,243,1) 35%, rgba(255,165,2,1) 65%, rgba(255,0,0,1) 85%, rgba(255,0,140,0) 100%)",
...
//             style={{
//               background:
//                 "linear-gradient(180deg, rgba(255,0,140,0) 0%, rgba(255,0,140,1) 15%, rgba(0,112,243,1) 35%, rgba(255,165,2,1) 65%, rgba(255,0,0,1) 85%, rgba(255,0,140,0) 100%)",
